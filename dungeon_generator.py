...
class BadMapException(Exception): pass
    ...
    def makeExit(self, rn):
        ...
        while try_count < 50:
            ...
            if self.mapArr[ry][rx] == 2:  # If space is a wall, exit
                break
            try_count += 1
        if try_count == 50: raise BadMapException()
...
def getMap(startx=80, starty=40):
    ...
    themap = dMap()
    try: themap.makeMap(startx, starty, 110, 50, 60)
    except BadMapException as e: return getMap(startx=80, starty=40)
